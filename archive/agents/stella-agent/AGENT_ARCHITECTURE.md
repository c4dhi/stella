# STELLA Agent Architecture - Message Processing Pipeline

This document describes how the STELLA conversational AI agent processes messages from input to output, excluding STT/TTS implementation details.
...
1. **BaseInstructionsComponent**: Core STELLA identity + required output format
