"""
Adapter for converting Stella Agent state machine to SDK ProgressState.
...
from stella_agent.models.state_machine import Plan, State, StateType, Task, TaskStatus, DeliverableStatus


class ProgressAdapter:
    """
    Converts Stella Agent state machine state to generic SDK ProgressState.
