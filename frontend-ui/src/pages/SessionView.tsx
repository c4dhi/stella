...
import { progressUpdateToTodoList, reconstructTasksFromItems, resolveStateType } from '../lib/progressConversion'
  ...
  useEffect(() => {
    ...
    const handleProgressUpdate = (data: ProgressUpdateMessage) => {
      try {
        ...
        // Convert using shared utility (same logic used for historical replay)
        const todoList = progressUpdateToTodoList(data)
