...
const StateStatusIcon = ({ status }: { status: StateStatus }) => {
  switch (status) {
    ...
    case StateStatus.IN_PROGRESS:
      return (
        <div className="w-3 h-3 rounded-full bg-blue-500 dark:bg-cyan-500" />
      )
    default:
      return (
...
const TaskStatusIcon = ({ status }: { status: TaskStatus }) => {
  switch (status) {
    ...
    case TaskStatus.IN_PROGRESS:
      return <div className="w-4 h-4 rounded-full bg-blue-500 dark:bg-cyan-500 flex-shrink-0" />
      ...
      <div
        className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all border ${
          isSkipped
            ...
            ? 'bg-blue-50/50 dark:bg-cyan-900/20 border-blue-200/60 dark:border-cyan-800/60 hover:bg-blue-50/70 dark:hover:bg-cyan-900/30'
  ...
  return (
    <motion.div
      ...
      className={`rounded-lg border transition-all ${
        isCurrentState
          ? 'border-blue-400/70 dark:border-cyan-600/70 bg-gradient-to-br from-blue-50/80 to-blue-100/40 dark:from-cyan-900/30 dark:to-cyan-800/20 shadow-md ring-1 ring-blue-200/50 dark:ring-cyan-700/50'
