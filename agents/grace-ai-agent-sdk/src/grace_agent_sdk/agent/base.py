...
from grace_agent_sdk.messages.types import AgentState, ChatMessage, MetadataSubtype, OutputType

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from grace_agent_sdk.audio.pipeline import AudioPipeline
    from grace_agent_sdk.services.history_client import HistoryClient


class BaseAgent(ABC):
    """
    Abstract base class for Grace AI agents.
    ...
    Example:
        ```python
        from grace_agent_sdk import BaseAgent, AgentInput, AgentOutput
