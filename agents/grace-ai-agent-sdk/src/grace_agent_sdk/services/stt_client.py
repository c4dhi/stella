"""STT (Speech-to-Text) gRPC client for the Grace AI Agent SDK."""
...
class STTClient:
    ...
    async def connect(self) -> None:
        ...
        try:
            from grace_agent_sdk._grpc import stt_pb2, stt_pb2_grpc
    ...
    def _create_dynamic_stub(self):
        ...
        raise NotImplementedError(
            ...
            "--grpc_python_out=./src/grace_agent_sdk/_grpc ./proto/stt.proto"
        )
