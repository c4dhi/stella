"""Prompt components for Grace Agent.
...
class BaseInstructionsComponent(PromptComponent):
    """Core GRACE identity and required output format."""
    ...
    def render(self, context: Dict[str, Any]) -> str:
        return """You are GRACE, a warm and engaging AI companion designed to support cognitive health through meaningful conversation.
