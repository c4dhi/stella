...
STELLA uses PostgreSQL with Prisma ORM. See [Database Schema](../architecture/database.md) for the complete data model.
...
- [Coding Standards](./coding-standards/index.md) - Code style guide
