...
We maintain a dedicated folder at [`docs/agent-failures/`](https://github.com/c4dhi/STELLA_backend/tree/main/docs/agent-failures) where we systematically collect agent failures and edge cases as we encounter them. These entries serve as regression test cases and feed into agent documentation.
